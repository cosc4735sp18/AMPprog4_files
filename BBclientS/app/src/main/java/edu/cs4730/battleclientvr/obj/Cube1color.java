...
public class Cube1color {
    ...
    public void draw(float[] mvpMatrix, int colornum) {
        ...
        //draw front face
        GLES30.glUniform4fv(mColorHandle, 1, myColor.pickcolor(colornum), 0);
